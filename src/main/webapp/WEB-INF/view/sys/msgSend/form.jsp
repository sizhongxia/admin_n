                            ...
                            <form id="mform" class="am-form tpl-form-border-form" data-am-validator modelAttribute="msgSend" method="post">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-10" id="usersHtml">
                                        <button type="button" class="am-btn am-btn-primary am-btn-xs" onclick="openModel(false,'${ctx}/user/selectUser?users=${msgSend.users}')"><span class="am-icon-plus"></span></button>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-10 am-u-sm-push-2">
                                        <button type="button" class="am-btn am-btn-danger" onclick="closeModel(false)">取消</button>
...
<script type="text/template" id="usersTpl" desc="发送给模板">
    ...
    <#}#>
        <button type="button" class="am-btn am-btn-primary am-btn-xs" onclick="openModel(false,'${ctx}/user/selectUser?users=<#=ids #>')"><span class="am-icon-plus"></span></button>
</script>
