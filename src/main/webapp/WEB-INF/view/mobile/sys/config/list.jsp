                                ...
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button type="button" class="am-btn am-btn-default am-btn-success"
                                                onclick="openModel(false,'${ctx}/sys/config/create')"><span class="am-icon-plus"></span> 新增
                                        </button>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <c:if test="${not empty page.entity.moduleName}"><span class="tags"><input type="hidden" name="moduleName" value="${page.entity.moduleName}" />模块名称=${page.entity.moduleName} <a href="javascript:;" onclick="$(this).parent().remove()">x</a></span></c:if>
                                                <span class="am-select am-input-group-sm">
                                                     <input type="text" class="am-select-input" autocomplete="off" style="border: none;"
                                                            placeholder="关键字" am-data='[{"field":"sysName","desc":"系统名称","type":"string"},{"field":"moduleName","desc":"模块名称","type":"string"}]'>
                                ...
                                <table id="contentTable" class="am-table am-table-compact am-text-nowrap tpl-table-black" width="100%">
                                    ...
                                    <c:forEach items="${page.list}" var="config" varStatus="status">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:;" onclick="openModel(false,'${ctx}/sys/config/update?id=${config.id}')" title="编辑"><span class="am-icon-pencil"></span></a>
